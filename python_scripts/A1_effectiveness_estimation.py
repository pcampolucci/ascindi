...
cp = fit_axis(dcmd_af[:,0:4], ddgyro_f[:,[0]], 'p', 0, N)
cq = fit_axis(dcmd_af[:,0:4], ddgyro_f[:,[1]], 'q', 0, N)
ca = fit_axis(dcmd_af[:,0:4], daccel_f[:,[2]], 'accel', start, end)
# Use all commands, to see if there is crosstalk
cr = fit_axis(np.hstack((dcmd_af[:,0:4], ddcmd_af[:,0:4]/sf)), ddgyro_f[:,[2]], 'r', 0, end)

print(*cp, sep = ',')

print('<define name="G1_ROLL" value="{',str(cp[0,0]*1000),",",str(cp[1,0]*1000),",",str(cp[2,0]*1000),",",str(cp[3,0]*1000),'}"/>')
print('<define name="G1_PITCH" value="{',str(cq[0,0]*1000),",",str(cq[1,0]*1000),",",str(cq[2,0]*1000),",",str(cq[3,0]*1000),'}"/>')
print('<define name="G1_YAW" value="{',str(cr[0,0]*1000),",",str(cr[1,0]*1000),",",str(cr[2,0]*1000),",",str(cr[3,0]*1000),'}"/>')
print('<define name="G1_THRUST" value="{',str(ca[0,0]*1000),",",str(ca[1,0]*1000),",",str(ca[2,0]*1000),",",str(ca[3,0]*1000),'}"/>')
print('<define name="G2" value="{',str(cr[4,0]*1000),",",str(cr[5,0]*1000),",",str(cr[6,0]*1000),",",str(cr[7,0]*1000),'}"/>')
